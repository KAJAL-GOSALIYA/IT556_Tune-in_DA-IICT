...
start = time.time()
df1 = pd.read_csv('subdata/100_data.csv', dtype={'rating': float})
...
start = time.time()
df2 = pd.read_csv('subdata/1000_data.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
start = time.time()
df3 = pd.read_csv('subdata/10000_data.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
...
start = time.time()
df4 = pd.read_csv('subdata/20000_data.csv', dtype={'rating': float})
reader = Reader(rating_scale=(1, 5))
